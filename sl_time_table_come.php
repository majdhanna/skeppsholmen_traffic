...
$str = file_get_contents('http://api.sl.se/api2/realtimedepartures.json?key=' . API_KEY . '&siteid=1026&timewindow=60');
	...
	$str2 = file_get_contents('http://api.sl.se/api2/realtimedepartures.json?key=<your SL api key>&siteid=314&timewindow=60');
